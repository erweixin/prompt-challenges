...
export const challenges: ChallengeGroup[] = [
  {
    ...
    challenges: [
      ...
      },
      {
        ...
        path: '/warm/03-text-classification-new.md',
      ...
      },
      {
        ...
        path: '/warm/04-language-detection-new.md',
    ...
    challenges: [
      {
        ...
        path: '/medium/00-role-playing-new.md',
      ...
      },
      {
        ...
        path: '/medium/01-reverse-thinking-new.md',
      ...
      },
      {
        ...
        path: '/medium/02-instruction-following-new.md',
      ...
      },
      {
        ...
        path: '/medium/03-multimodal-processing-new.md',
      ...
      },
      {
        ...
        path: '/medium/04-context-understanding-new.md',
    ...
    challenges: [
      {
        ...
        path: '/hard/00-chain-of-thought-new.md',
      ...
      },
      {
        ...
        path: '/hard/01-prompt-injection-defense-new.md',
      ...
      },
      {
        ...
        path: '/hard/02-counterfactual-reasoning-new.md',
      ...
      //   path: '/hard/03-function-call-new.md',
      ...
      // },
      {
        ...
        path: '/hard/03-multilingual-processing-new.md',
      ...
      },
      {
        ...
        path: '/hard/04-knowledge-reasoning-new.md',
    ...
    challenges: [
      {
        ...
        path: '/extreme/00-self-improving-prompt-new.md',
      ...
      },
      {
        ...
        path: '/extreme/01-adversarial-qa-new.md',
