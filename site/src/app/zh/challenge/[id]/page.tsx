        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link 
                href={`/${locale}`}
                className="inline-flex items-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 hover:scale-105"
              >
            ...
            <div className={`p-8 border-b border-gray-200/50 dark:border-gray-700/50 ${config.bg} relative overflow-hidden`}>
              ...
              <div className="relative">
                <div className="flex items-center space-x-3 mb-4">
                  <div className={`p-2 rounded-xl bg-white/80 dark:bg-gray-800/80 shadow-sm ${config.shadow}`}>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                      {dict.difficulty[challenge.difficulty]} • 提示词工程挑战
                    </p>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center">
                {prev ? (
                  <Link 
                    ...
                    className="group inline-flex items-center text-sm text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-200 hover:scale-105"
                  >
                    <div className="p-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 mr-2 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-colors">
                ...
                {next ? (
                  ...
                  >
                    ...
                    <div className="p-1.5 rounded-lg bg-gray-100 dark:bg-gray-700 ml-2 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/30 transition-colors">
                      <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-6 border-t border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-gray-50/50 to-gray-100/50 dark:from-gray-700/30 dark:to-gray-800/30">
              <div className="text-center">
                ...
                <a 
                  ...
                  className="inline-flex items-center text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-all duration-200 hover:scale-105"
                >
